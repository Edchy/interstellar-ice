...
The _figure-ground_ principle is a powerful tool in graphic design, and it can be used to create some really interesting effects by blurring the line between figure and ground.
